...
const RegisterPage = () => {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            if (!result.success) { alert(result.message ?? "Registracija neuspešna!"); return; }
    ...
    return (
        <div className="register-container">
            <div className="register-box">
                ...
                <input type="text" placeholder="Gamer Tag..." value={gamerTag}
                    onChange={(e) => setGamerTag(e.target.value)} />
                <input type="text" placeholder="Ime i prezime..." value={fullName}
